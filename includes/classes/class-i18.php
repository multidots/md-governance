...
class I18 {
	 ...
	 *
	 * Uses the MD_Governance_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @return void
	 * @since    1.0.0
	...
	public function set_locale(): void {
		...
		$locale = apply_filters( 'plugin_locale', get_locale(), 'md-governance' );
		load_textdomain( 'md-governance', sprintf( '%s/%s.mo', MD_GOVERNANCE_LANGUAGE_DIR_PATH, $locale ) );
